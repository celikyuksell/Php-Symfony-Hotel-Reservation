 ...
 */
final class Version20191203144252 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD name VARCHAR(20) DEFAULT NULL, ADD surname VARCHAR(20) DEFAULT NULL, ADD image VARCHAR(50) DEFAULT NULL, ADD status VARCHAR(10) DEFAULT NULL, ADD created_at DATETIME DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP name, DROP surname, DROP image, DROP status, DROP created_at, DROP updated_at, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
    }
}
